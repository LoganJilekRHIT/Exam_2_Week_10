...
def run_test_init():
    ...
    b2 = Bank('Logan', 1000000, '626')
    expected_name = 'Logan'
    expected_balance = 1000000
    expected_account_number = '626'
    print("Expected:", expected_name, expected_balance, expected_account_number)
    ...
    b3 = Bank('John Doe', .62, '73')
    expected_name = 'John Doe'
    expected_balance = .62
    expected_account_number = '73'
    print("Expected:", expected_name, expected_balance, expected_account_number)
...
def run_test_withdraw():
    ...
    b1 = Bank('Logan', 1000000, '626')
    expected_balance = 999920
    print('expected:', expected_balance)
    print('actual:', b1.withdraw(80))
    if expected_balance == b1.balance:
        print('Test passed')
    else:
        print_failure_message()
    print()

    b2 = Bank('Random Guy', 3, '21')
    expected_balance = 1
    print('expected:', expected_balance)
    print('actual:', b2.withdraw(2))
    if expected_balance == b2.balance:
        print('Test passed')
    else:
        print_failure_message()
    print()
    ...
    expected_balance = 70
    print('expected:', expected_balance)
    print('actual:', b3.withdraw(80))
    if expected_balance == b3.balance:
        print('Test passed')
    else:
        print_failure_message()
    print()
